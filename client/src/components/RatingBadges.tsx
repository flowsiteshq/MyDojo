 ...
 * Used above testimonials sections to establish social proof credibility.
 */
    ...
    <div className="flex items-center gap-0.5">
      {Array.from({ length: 5 }).map((_, i) => (
        <svg
          ...
          viewBox="0 0 20 20"
          className="w-4 h-4"
          fill={i < count ? color : "rgba(255,255,255,0.2)"}
        >
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-2">
            <span className="text-white font-black text-xl leading-none">5.0</span>
            <StarRow count={5} color="#FBBC05" />
          </div>
